...
/**
 * Represents an escrow contract.
 */
export class EscrowContract {
  /**
   * Creates a new EscrowContract instance.
   ...
   * @param {boolean} [network='mainnet'] - The network to create the contract. Defaults to 'mainnet'.
   */
  constructor (publicKeys, addresses, fees, timestamp, network = 'mainnet') {
