...
export default {
  ...
  ConfirmDeleteMemo: "Подтвердить удаление заметки",
  ...
  ConversionInfo: "Информация о конвертации",
  Convert: "Convert",
  ...
  FavoriteTokensLimitReached: "Достигнут лимит избранных токенов",
  Favorites: "Favorites",
  ...
  Invoice: "Invoice",
  InvoiceExpired: "Счет истек",
  InvoiceExpiringSoon: "Счет скоро истечет",
