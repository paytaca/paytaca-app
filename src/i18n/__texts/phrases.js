...
const phrases = {
  static: [
    {
      ...
      DeactivatePlanConfirm: 'Are you sure you want to deactivate this plan?',
    ...
    // =========================
    {
      ...
      // user rewards continuous points transactions history page
  ...
  dynamic: [
    ...
    // ===== Multisig Wallets =====
    {
      ...
      ChatResetSuccess: 'Chat reset successfully. Conversations are being re-fetched.',
      ...
      Discount: 'Discount',
      ErrorLoadingContact: 'Error loading contact',
      Exit: 'Exit',
      InvalidSeedPhraseError: 'Invalid seed phrase',
    ...
    // ===== Chat - MLS Group Management (dynamic) =====
    {
