...
export default {
  ...
  PrivateGroupDesc: "End-to-end encrypted group chat for up to 10 members. Members are fixed once created.",
  ...
  PublicGroupDesc: "End-to-end encrypted group chat for up to 10,000 members. New members can join anytime.",
  ...
  ResetChatConfirm: "Clear all conversations and re-fetch them from the relay? Your contacts and profile will also be deleted.",
  ResetChatDescription: "Clear all conversations and re-fetch them from the relay. Your contacts and profile are also deleted.",
