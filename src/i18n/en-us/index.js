...
export default {
  ...
  ImportAsReadOnly: "Import as Read-Only",
  ImportReadOnlyDescription: "View-only access using xPub key",
  ImportReadOnlyWallet: "Import Read-Only Wallet",
  EnterXPubKey: "Enter xPub key",
  EnterWalletHash: "Enter wallet hash",
  WalletHashRequiredDescription: "Required to view balance and transactions. Find this in your original wallet Settings → Wallet Info.",
  InvalidXPubKey: "Invalid xPub key. Please check and try again.",
  InvalidXPubKeyFormat: "Invalid xPub key format. Please enter a valid xPub key.",
  InvalidWalletHash: "Invalid wallet hash. Must be 64 characters.",
  WalletHashRequired: "Wallet hash is required.",
  FailedToImportWallet: "Failed to import wallet. Please try again.",
  ReadOnly: "Read-Only",
  ReadOnlyWallet: "Read-Only Wallet",
  ReadOnlyWalletWarning: "This is a read-only wallet. You cannot send transactions from this wallet.",
  ClipboardAccessDenied: "Could not access clipboard. Please paste manually.",
  QRScannerComingSoon: "QR scanner for xPub keys coming soon",
