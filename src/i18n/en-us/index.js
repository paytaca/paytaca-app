...
export default {
  ...
  EstimatedTimeBasedOnBlocks: "The displayed time is an estimate based on the Bitcoin Cash network block target of 10 minutes per block. The exact interval is",
