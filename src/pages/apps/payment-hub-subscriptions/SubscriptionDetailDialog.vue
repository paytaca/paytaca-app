      ...
      <q-card-section v-else-if="sub" class="q-pt-md">
        ...
        <div class="row justify-between items-start q-mb-lg">
          <div class="col">
            ...
            <div class="text-h6 q-mt-sm">{{ sub.plan_details?.name || 'Subscription' }}</div>
        ...
        <div class="q-mb-md">
          ...
          <div class="row no-wrap items-center">
            <div class="text-body2 ellipsis q-mr-xs font-mono" style="max-width: 340px;">{{ sub.contract_address }}</div>
            <q-btn flat round dense icon="content_copy" size="sm" @click="copyText(sub.contract_address, 'Contract Address')" />
          </div>
        </div>
