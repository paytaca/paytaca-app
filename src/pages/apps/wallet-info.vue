  ...
  methods: {
    ...
    async scanAddresses () {
      ...
      try {
        ...
        // Scan from index 0 to cover all addresses up to last known index plus lookahead
        // BIP44 standard uses gap limit of 20 for external chain
        const startIndex = 0
        const gapLimit = 20
        // Scan from 0 to lastAddressIndex + gapLimit to ensure we look ahead for addresses
        // that may have been generated by other wallets but not yet tracked
