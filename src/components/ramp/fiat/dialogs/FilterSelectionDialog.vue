...
<template>
  <q-dialog ref="dialog" position="standard" transition-show="jump-down" @before-hide="customKeyboard = 'dismiss'" no-shake>
    <q-card class="br-15 pt-card-2 text-bow filter-dialog-card" :class="getDarkModeClass(darkMode)">
