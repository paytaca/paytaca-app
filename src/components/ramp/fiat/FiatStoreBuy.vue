                ...
                <div class="q-pt-md subtext" style="font-size: 12px;">
                    ...
                    <div :class="[darkMode ? 'pt-dark-label' : 'pp-text']" class="row justify-between no-wrap q-mx-lg">
                        ...
                        <span class="text-nowrap q-ml-xs">
                            {{ adDetails.trade_floor }} {{ adDetails.fiat_currency.abbrev }}
                        </span>
                    </div>
                    <div :class="[darkMode ? 'pt-dark-label' : 'pp-text']" class="row justify-between no-wrap q-mx-lg">
                ...
                <div class="q-mt-md q-mx-lg">
                    <q-input dense filled :dark="darkMode" v-model="amount">
                        <template v-slot:prepend>
                            <span style="font-size: 12px; font-weight: 400;">PHP</span>
                        </template>
      ...
      <div v-if="!hideSellerInfo">
        ...
        <div v-if="!hideSellerInfo && adDetails != null">
            ...
            <div class="row">
                <div class="col ib-text">
                    <div class="q-mx-lg q-mt-md">
                        <span :class="{'pt-dark-label': darkMode}" class="q-pl-md q-mb-none text-uppercase" style="font-size: 15px; font-weight: 400;">
        ...
        <div class="q-mx-lg q-pt-sm">
          <div class="q-ml-xs  q-gutter-sm">
            <q-badge v-for="method in buy.paymentMethods" rounded outline color="blue" :label="method.name"/>
          </div>
        </div>
