...
Instead of exporting the multisig wallet as a file for manual sharing, you can upload it to the Paytaca server, allowing access from your other devices and by your cosigners. This operation uploads only the essential wallet details—such as the wallet name, signer xpubs, and required number of signatures—to the server. <strong>Private keys are never uploaded.</strong>
        </div>
