<template>
  <div class="row no-wrap q-gutter-md q-pl-lg q-pb-md" id="asset-container" v-show="assets">
    ...
    >
      ...
      <div style="position: absolute; bottom: 25px; background: gray; border-radius: 5px; font-size: 11px; padding-left: 3px; padding-right: 3px;">{{ asset.id.split('/')[0].toUpperCase() }}</div>
