...
export default {
	data () {
		return {
			...
			bchOpt: [				
		        { name: 'send', icon: 'img:ui-revamp/send-bch.png' },
		        { name: 'receive', icon: 'img:ui-revamp/receive-bch.png' },
		        { name: 'cashin', icon: 'img:ui-revamp/cashin.png' },
		        { name: 'price chart', icon: 'query_stats' }
			],
			stablehedgeOpt: [		
		        { name: 'freeze', icon: 'ac_unit' },
		        { name: 'unfreeze', icon: 'img:ui-revamp/unfreeze.svg' },		        
		        { name: 'price chart', icon: 'query_stats' }
			],
		}
	},
