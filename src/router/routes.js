    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'wallet/:address/transaction/:index', component: () => import('src/pages/apps/multisig/wallet/transaction/view.vue'), name: 'app-multisig-wallet-transaction-view' },
          { path: 'wallet/:address/pst', component: () => import('src/pages/apps/multisig/wallet/pst/index.vue'), name: 'app-multisig-wallet-psts' },
          { path: 'wallet/:address/pst/create', component: () => import('src/pages/apps/multisig/wallet/pst/create.vue'), name: 'app-multisig-wallet-pst-create' },
          { path: 'wallet/:address/pst/:id', component: () => import('src/pages/apps/multisig/wallet/pst/view.vue'), name: 'app-multisig-wallet-pst-view' }
        ]
      }
    ]
  },
