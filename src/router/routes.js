...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'auction',
        component: () => import('src/layouts/AuctionLayout.vue'),
        children: [
          ...
          { path: 'appeals/:appealId', component: () => import('src/pages/apps/auction/appeal-details.vue'), name: 'app-auction-appeal-details', props: true },
