    ...
    children: [
      ...
      // ===== AUCTION ROUTE =====
      {
        ...
        children: [
          ...
          { path: 'auctiondetails/:auctionId', component: () => import('src/pages/apps/auction/auction-details.vue'), name: 'app-auction-details', props: route => Object.assign({}, route.params, route.query) },
          { path: 'lotdetails/:lotId', component: () => import('src/pages/apps/auction/lot-details.vue'), name: 'app-auction-lot-details', props: route => Object.assign({}, route.params, route.query) }
        ]
      },
      {
        path: 'crypto-swap/',
      ...
      },
      {
        ...
        children: [
          ...
          { 
            ...
            name: 'app-multisig-wallet-asset',
            meta: {
              /**
               * @type {{ asset: 'bch'|string }} - Either 'bch' or a token category
               */
              queryType: {}
            }
          },
          { 
            path: 'wallet/:wallethash/addresses',
          ...
          },
          {
            ...
            name: 'app-multisig-wallet-transaction-send',
            meta: {
              /**
               * @type {{ asset: 'bch'|string }} - Either 'bch' or a token category
               */
          ...
          },
          {
            ...
            component: () => import('src/pages/apps/multisig/wallet/pst/index.vue'),
            name: 'app-multisig-wallet-psts'
          },
          {
            path: 'wallet/:wallethash/pst/:unsignedtransactionhash/import',
            component: () => import('src/pages/apps/multisig/wallet/pst/import.vue'),
